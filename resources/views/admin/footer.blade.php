...
<footer class="site-footer">
  ...
  <script src="{{ asset('assets') }}/global/vendor/chartist/chartist.min599c.js?v4.0.2"></script>
  <script src="{{ asset('assets') }}/global/vendor/aspieprogress/jquery-asPieProgress.min599c.js?v4.0.2"></script>
  <script src="{{ asset('assets') }}/global/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min599c.js?v4.0.2"></script>
  ...
  <script src="{{ asset('assets') }}/global/js/Plugin/aspieprogress.min599c.js?v4.0.2"></script>
  <script src="{{ asset('/') }}assets/examples/js/dashboard/ecommerce.min599c.js?v4.0.2"></script>
